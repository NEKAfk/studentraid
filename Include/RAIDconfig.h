...
#define DECLAREPARAMS_3(type, name, type2, name2, type3, name3)                                                        \
  DECLAREPARAM(type, name) DECLAREPARAMS_2(type2, name2, type3, name3)
#define DECLAREPARAMS_4(type, name, type2, name2, type3, name3, type4, name4)                                          \
  DECLAREPARAM(type, name) DECLAREPARAMS_3(type2, name2, type3, name3, type4, name4)
#define DECLAREPARAMS_5(type, name, type2, name2, type3, name3, type4, name4, type5, name5)                            \
  DECLAREPARAM(type, name) DECLAREPARAMS_4(type2, name2, type3, name3, type4, name4, type5, name5)
#define DECLAREPARAMS_6(type, name, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)              \
  DECLAREPARAM(type, name) DECLAREPARAMS_5(type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)
#define DECLAREPARAMS_7(                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
    type2,                                                                                                             \
    name2,                                                                                                             \
  ...
  DECLAREPARAMS_6(type2, name2, type3, name3, type4, name4, type5, name5, type6, name6, type7, name7)
#define DECLAREPARAMS_8(                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
    type2,                                                                                                             \
    name2,                                                                                                             \
  ...
  DECLAREPARAM(type, name)                                                                                             \
  DECLAREPARAMS_7(type2, name2, type3, name3, type4, name4, type5, name5, type6, name6, type7, name7, type8, name8)
#define DECLAREPARAMS_9(                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
    type2,                                                                                                             \
    name2,                                                                                                             \
...
#define INITPARAM_3(cfg, type, name, type2, name2, type3, name3)                                                       \
  , name(cfg_get##type(cfg, #name)) INITPARAM_2(cfg, type2, name2, type3, name3)
#define INITPARAM_4(cfg, type, name, type2, name2, type3, name3, type4, name4)                                         \
  , name(cfg_get##type(cfg, #name)) INITPARAM_3(cfg, type2, name2, type3, name3, type4, name4)
#define INITPARAM_5(cfg, type, name, type2, name2, type3, name3, type4, name4, type5, name5)                           \
  , name(cfg_get##type(cfg, #name)) INITPARAM_4(cfg, type2, name2, type3, name3, type4, name4, type5, name5)
#define INITPARAM_6(cfg, type, name, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)             \
  , name(cfg_get##type(cfg, #name))                                                                                    \
        INITPARAM_5(cfg, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)
#define INITPARAM_7(                                                                                                   \
    cfg,                                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
  ...
  , name(cfg_get##type(cfg, #name))                                                                                    \
        INITPARAM_6(cfg, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6, type7, name7)
#define INITPARAM_8(                                                                                                   \
    cfg,                                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
  ...
  , name(cfg_get##type(cfg, #name)) INITPARAM_7(                                                                       \
        cfg,                                                                                                           \
        type2,                                                                                                         \
        name2,                                                                                                         \
        type3,                                                                                                         \
...
#define INITPARAM_9(                                                                                                   \
  ...
  , name(cfg_get##type(cfg, #name)) INITPARAM_8(                                                                       \
        cfg,                                                                                                           \
        type2,                                                                                                         \
        name2,                                                                                                         \
        type3,                                                                                                         \
...
#define DECLARECONFIG_2(type, name, type2, name2)                                                                      \
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE), DECLARECONFIG_1(type2, name2)
#define DECLARECONFIG_3(type, name, type2, name2, type3, name3)                                                        \
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE), DECLARECONFIG_2(type2, name2, type3, name3)
#define DECLARECONFIG_4(type, name, type2, name2, type3, name3, type4, name4)                                          \
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE), DECLARECONFIG_3(type2, name2, type3, name3, type4, name4)
#define DECLARECONFIG_5(type, name, type2, name2, type3, name3, type4, name4, type5, name5)                            \
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE),                                                                      \
      DECLARECONFIG_4(type2, name2, type3, name3, type4, name4, type5, name5)
#define DECLARECONFIG_6(type, name, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)              \
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE),                                                                      \
      DECLARECONFIG_5(type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)
#define DECLARECONFIG_7(                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
    type2,                                                                                                             \
    name2,                                                                                                             \
  ...
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE),                                                                      \
      DECLARECONFIG_6(type2, name2, type3, name3, type4, name4, type5, name5, type6, name6, type7, name7)
#define DECLARECONFIG_8(                                                                                               \
    type,                                                                                                              \
    name,                                                                                                              \
    type2,                                                                                                             \
    name2,                                                                                                             \
  ...
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE), DECLARECONFIG_7(                                                     \
                                                      type2,                                                           \
                                                      name2,                                                           \
                                                      type3,                                                           \
                                                      name3,                                                           \
...
#define DECLARECONFIG_9(                                                                                               \
  ...
  CFG_##type(#name, (cfg_t_##type) 0, CFGF_NONE), DECLARECONFIG_8(                                                     \
                                                      type2,                                                           \
                                                      name2,                                                           \
                                                      type3,                                                           \
                                                      name3,                                                           \
...
#define RAIDLIST(NumOfTypes, ...)                                                                                      \
  enum eRAIDTypes {                                                                                                    \
    FOREACH__(NumOfTypes, (DECLARE, __VA_ARGS__ rtEnd))                                                                \
  };                                                                                                                   \
...
#define PARSERAID(name, ...)                                                                                           \
  CRAIDProcessor* Parse##name(cfg_t* cfg) {                                                                            \
    if (!cfg_size(cfg, #name))                                                                                         \
      return 0;                                                                                                        \
...
#define CFGOPTIONLIST(name, count, ...)                                                                                \
  cfg_opt_t name##_opts[] = {                                                                                          \
      CFG_unsigned("Dimension", 0, CFGF_NONE),                                                                         \
      CFG_unsigned("InterleavingOrder", 1, CFGF_NONE),                                                                 \
      CFG_unsigned("StripeUnitSize", 0, CFGF_NONE),                                                                    \
      DECLARECONFIG__(count, (__VA_ARGS__))                                                                            \
  };
/// generates a constructor body from a configuration file section
#define CFGCONSTRUCTORIMPL(name, count, ...)                                                                           \
  name##Params::name##Params(cfg_t* cfg)                                                                               \
      : RAIDParams(                                                                                                    \
            rt##name,                                                                                                  \
            cfg_getint(cfg, "Dimension"),                                                                              \
            cfg_getint(cfg, "InterleavingOrder"),                                                                      \
            cfg_getint(cfg, "StripeUnitSize")                                                                          \
        ) INITPARAM__(count, (cfg, __VA_ARGS__)) {}
...
#define PARSECONFIG(NumOfTypes, ...)                                                                                   \
  FOREACH__(NumOfTypes, (PARSE, __VA_ARGS__));                                                                         \
  LISTFUCTORS(NumOfTypes, __VA_ARGS__);                                                                                \
  LISTNAMES(NumOfTypes, __VA_ARGS__);
...
#pragma pack(push)
#pragma pack(1)
RAIDLIST(3, RAID(RAID5, 0), RAID(RS, 1, unsigned, Redundancy), RAID(RDP, 1, unsigned, PrimeNumber))
#pragma pack(pop)
